...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>John Rzansky's Blog</title>
            ...
            <div class="col-lg-6 col-md-7 col-sm-12 mx-auto align-self-center">
                <div class="login-form">
                    <div class="text-center">
                        ...
                        <p>Sign in to your account to start using John Rzansky's Blog</p>
                    </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="pages-left h-100">
                    <div class="login-content">
                        ...
                        <a href="index.html"><img src="/images/logo-white.png" class="mb-3 logo-light" alt=""></a>
                        <p>Write your thoughts and preserve them for the future.</p>
                    </div>
